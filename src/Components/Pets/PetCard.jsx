...
export default function PetCard({data}) {
  return (
    <Link to='/#' className='relative flex flex-col items-center w-1/4 min-h-[280px] max-h-[350px] min-w-[280px] max-w-[350px] aspect-[1/1] mx-10 hover:scale-105 transition'>
